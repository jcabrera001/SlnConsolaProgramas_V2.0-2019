...
Public Class GenAsientosMQFrm
    ...
    Public Sub New(cnx As SqlConnection, user As String, pwd As String, empresa As String, tiempo As Integer)
        ...
        time = tiempo
    End Sub
    Private Sub GenAsientosMQFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub EjecutarProceso(generar As Boolean)
        ...
        Else
            sql = "spMTP_ObtenerAsientos_MAQ @SitioID, @ZafraID, @SemanaID, @TipoTransaccion, @SelectorReg"
        End If
