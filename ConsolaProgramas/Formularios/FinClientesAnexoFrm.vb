...
#Region "Procedimientos Definidos por el usuario"
    ...
    Public Sub CargarRegistros()
        ...
        Try
            ...
            DtDatos = IDF_ClientesAnexo.Tabla("Select B.TP,B.Description," & _
                                              "A.TP AS TP2,A.Direccion,A.Direccion,a.RTN,A.DirCliente2,A.DirCliente3," & _
                                              "A.TelCliente1, A.TelCliente2, A.EmailCliente1, A.EmailCliente2, B.Tipo " & _
