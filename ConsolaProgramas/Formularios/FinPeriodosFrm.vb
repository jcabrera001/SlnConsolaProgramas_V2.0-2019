...
Public Class FinPeriodosFrm
    ...
    Private Sub CmbEditar_Click(sender As Object, e As EventArgs) Handles CmbEditar.Click
        ...
        cCodigoRegistro = GrdConsultaView.GetRowCellValue(GrdConsultaView.FocusedRowHandle, "PeriodoID")
    ...
    Private Sub CmbEliminar_Click(sender As Object, e As EventArgs) Handles CmbEliminar.Click
        Dim oRegistro As New IDF_Periodos(ClsConexion.CadenaFinanzas(strUsuario, strPassword))
...
#Region "Procedimientos Definidos por el usuario"
    ...
    Public Sub Editar(cDato As String)
        ...
        Dim oRegEdicion As New IDF_Periodos(ClsConexion.CadenaFinanzas(strUsuario, strPassword))

        oRegEdicion = IDF_Periodos.Buscar("PeriodoID='" & cDato & "'")
    ...
    Public Sub Nuevo()
        ...
        Dim oRegNuevo As New IDF_Periodos(ClsConexion.CadenaFinanzas(strUsuario, strPassword))
    ...
    Public Sub CargarRegistros()
        ...
        ClsPeriodos = New IDF_Periodos(ClsConexion.CadenaFinanzas(strUsuario, strPassword))

        Try
            DtDatos = IDF_Periodos.Tabla()
