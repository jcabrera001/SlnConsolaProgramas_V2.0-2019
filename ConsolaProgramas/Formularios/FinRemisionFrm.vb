...
#Region "Procedimientos Definidos por el usuario"
    ...
    Public Sub CargarConsulta()
        ...
        Try
            DtDatosDFFacts = IDF_Remisiones.Tabla("Select A.*, B.Descripcion As CondNombre From IDF_Remisiones A Left Join IDF_Conductores B on A.ConductorID=B.ConductorID  Where A.TiposDoctoID in (" & IntTipoDocto & ") and A.EmpresaCodigo = '" & StrEmpresa & "' Order by RemNum")
    ...
    Public Sub Nuevo()
        ...
        Me.TxtFechaInicio.EditValue = oRemisionNuevo.FechaInicio
        Me.TxtFechaFinal.EditValue = oRemisionNuevo.FechaFinal
    ...
    Public Sub Editar(nDato As Integer)
        ...
        Me.lblEstado.Text = IIf(oRemEdicion.Estado = 0, "En Proceso", IIf(oRemEdicion.Estado = 1, "Aprobado", "Anulado"))
    ...
    Public Sub Grabar(cAccion As String)
        ...
        oRemisionRegistro.Fecha = Me.TxtFecha.EditValue
    ...
    Public Sub ImprimirVarias(nRemisionID As Integer, nCantidad As Integer)
        ...
        Try
            ...
            ocInforme.SetParameterValue("@RemisionID", nRemisionID)
            ocInforme.SetDatabaseLogon(strUsuario, strPassword, "amigodb\amigodb", "Finanzas")
            ocInforme.PrintToPrinter(3, False, 0, 0)
            ocInforme.Close()
            ocInforme.Dispose()
