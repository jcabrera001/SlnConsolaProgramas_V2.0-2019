...
Public Class IDF_FactComp
    ...
    Public Function Actualizar(sel As String) As String
        ...
        sCommand = "UPDATE IDF_FactComp SET EmpresaCodigo = @EmpresaCodigo, CAIXSdNID = @CAIXSdNID, NDFEstab = @NDFEstab, NDFPuntoEm = @NDFPuntoEm, NDFTipoDoc = @NDFTipoDoc, NDFCorrelat = @NDFCorrelat, Fecha = @Fecha, CAEE = @CAEE, MontoTotal = @MontoTotal, Estado = @Estado, EsOCE = @EsOCE, OCEResolucion = @OCEResolucion, OCEFecha = @OCEFecha, UsuCreacion = @UsuCreacion, UsuEdicion = @UsuEdicion, UsuAnulacion = @UsuAnulacion, FechaCreacion = @FechaCreacion, FechaEdicion = @FechaEdicion, FechaAnulacion = @FechaAnulacion  WHERE (FactCompID = @FactCompID)"
    ...
    Public Function Crear() As String
        ...
        '       Yo compruebo que sea un campo llamado FactCompID, pero en tu caso puede ser otro
        sCommand = "INSERT INTO IDF_FactComp (EmpresaCodigo, CAIXSdNID, NDFEstab, NDFPuntoEm, NDFTipoDoc, NDFCorrelat, Fecha, CAEE, MontoTotal, Estado, EsOCE, OCEResolucion, OCEFecha, UsuCreacion, UsuEdicion, UsuAnulacion, FechaCreacion, FechaEdicion, FechaAnulacion)  VALUES(@EmpresaCodigo, @CAIXSdNID, @NDFEstab, @NDFPuntoEm, @NDFTipoDoc, @NDFCorrelat, @Fecha, @CAEE, @MontoTotal, @Estado, @EsOCE, @OCEResolucion, @OCEFecha, @UsuCreacion, @UsuEdicion, @UsuAnulacion, @FechaCreacion, @FechaEdicion, @FechaAnulacion)"
